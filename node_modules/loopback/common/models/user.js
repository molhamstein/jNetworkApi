  ...
  *    });
  ...
  User.resetPassword = function(options, cb) {
    ...
    UserModel.findOne({where: where}, function(err, user) {
	  ...
	  http.get(
					'http://services.mtn.com.sy/General/MTNSERVICES/ConcatenatedSender.aspx?User=LEMA%20ISP%202013&Pass=L1E2M3A4&From=LEMA-ISP&Gsm='+(user.mobile).substr(2)+'&Msg=Your%20Verification%20Code%20'+String(user.code)+'&Lang=0&Flash=0',
					  function(res) {
